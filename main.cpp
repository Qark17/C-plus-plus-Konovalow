...
/// @details Создает тестовые данные, демонстрирует полиморфизм и функциональность системы
/// @brief Отображает все продукты из коллекции
/// @param products - Вектор указателей на продукты
...
int main() {
    ...
    Order order1("Супермаркет 'Вкусный'", "CHOCO001", 100, 150.0);
    Order order2("Супермаркет 'Вкусный'", "CANDY001", 500, 80.0);
    Order order3("Минимаркет 'Сладости'", "CHOCO002", 50, 200.0);
    Order order4("Минимаркет 'Сладости'", "CAKE001", 10, 450.0);
    Order order5("Магазин 'У дома'", "CANDY002", 1000, 25.0);
